...
<path d="M26.7491 17.7096V17.005C26.7491 13.1362 23.7274 10 20 10C16.2726 10 13.2509 13.1362 13.2509 17.005V17.7096C13.2509 18.5552 13.0097 19.3818 12.5578 20.0854L11.4504 21.8095C10.4388 23.3843 11.211 25.5249 12.9704 26.0229C17.5727 27.3257 22.4273 27.3257 27.0296 26.0229C28.789 25.5249 29.5612 23.3843 28.5496 21.8095L27.4422 20.0854C26.9903 19.3818 26.7491 18.5552 26.7491 17.7096Z" stroke="#99A1B7" stroke-width="1.5"/>
<path d="M15.5 27C16.155 28.7478 17.9225 30 20 30C22.0775 30 23.845 28.7478 24.5 27" stroke="#99A1B7" stroke-width="1.5" stroke-linecap="round"/>
<circle cx="27" cy="13" r="4.5" fill="url(#paint0_linear_23_2396)" stroke="white"/>
<defs>
<linearGradient id="paint0_linear_23_2396" x1="23" y1="9" x2="32.3665" y2="14.789" gradientUnits="userSpaceOnUse">
...
<stop offset="1" stop-color="#007FC4"/>
                        ...
                        <div className="cover-image">
                           <img src="assets\images\cover.jpg" alt="dashboard-cover-img" className="cover-inner-image" />
                        </div>
                    </div>
                </div>
...
<path d="M9.66675 5L15.6667 12L9.66675 19" stroke="#99A1B7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
...
<path d="M21.1 29.5C21.1 29.9971 21.5029 30.4 22 30.4C22.4971 30.4 22.9 29.9971 22.9 29.5H21.1ZM22 9.5L22.7488 9.00077C22.5819 8.75039 22.3009 8.6 22 8.6C21.6991 8.6 21.4181 8.75039 21.2512 9.00077L22 9.5ZM23.7512 13.7492C24.0269 14.1628 24.5857 14.2746 24.9992 13.9988C25.4128 13.7231 25.5246 13.1643 25.2488 12.7508L23.7512 13.7492ZM18.7512 12.7508C18.4754 13.1643 18.5872 13.7231 19.0008 13.9988C19.4143 14.2746 19.9731 14.1628 20.2488 13.7492L18.7512 12.7508ZM22 9.5L21.2512 9.99923L23.7512 13.7492L24.5 13.25L25.2488 12.7508L22.7488 9.00077L22 9.5ZM22 9.5L21.2512 9.00077L18.7512 12.7508L19.5 13.25L20.2488 13.7492L22.7488 9.99923L22 9.5ZM22 29.5H22.9V25.75H22H21.1V29.5H22ZM22 25.75H22.9V9.5H22H21.1V25.75H22Z" fill="white"/>
<path d="M14.5 15.75V18.9481C14.5 20.0242 15.1886 20.9795 16.2094 21.3198L20.2906 22.6802C21.3114 23.0205 22 23.9758 22 25.0519V25.75" stroke="white" stroke-width="1.8" stroke-linecap="round"/>
<path d="M29.5 19.5V22.6981C29.5 23.7742 28.8114 24.7295 27.7906 25.0698L23.7094 26.4302C22.6886 26.7705 22 27.7258 22 28.8019V29.5" stroke="white" stroke-width="1.8" stroke-linecap="round"/>
<path d="M28.25 18.25C28.25 17.6607 28.25 17.3661 28.4331 17.1831C28.6161 17 28.9107 17 29.5 17C30.0893 17 30.3839 17 30.5669 17.1831C30.75 17.3661 30.75 17.6607 30.75 18.25C30.75 18.8393 30.75 19.1339 30.5669 19.3169C30.3839 19.5 30.0893 19.5 29.5 19.5C28.9107 19.5 28.6161 19.5 28.4331 19.3169C28.25 19.1339 28.25 18.8393 28.25 18.25Z" stroke="white" stroke-width="1.8"/>
</svg>
                                </span>
...
<rect x="0.666504" width="44" height="44" rx="12" fill="#FF8439"/>
<path d="M25.7032 30.1095L24.8021 31.0105C21.8163 33.9964 16.9752 33.9964 13.9894 31.0105C11.0035 28.0247 11.0035 23.1837 13.9894 20.1978L14.8905 19.2968" stroke="white" stroke-width="1.8" stroke-linecap="round"/>
<path d="M20.2969 24.7031L25.7032 19.2968" stroke="white" stroke-width="1.8" stroke-linecap="round"/>
<path d="M20.2969 13.8905L21.1979 12.9894C24.1838 10.0035 29.0248 10.0035 32.0107 12.9894C34.9965 15.9752 34.9965 20.8163 32.0107 23.8021L31.1096 24.7032" stroke="white" stroke-width="1.8" stroke-linecap="round"/>
</svg>
...
<path d="M9.5 22C9.5 16.1074 9.5 13.1612 11.3306 11.3306C13.1612 9.5 16.1074 9.5 22 9.5C27.8926 9.5 30.8388 9.5 32.6694 11.3306C34.5 13.1612 34.5 16.1074 34.5 22C34.5 27.8926 34.5 30.8388 32.6694 32.6694C30.8388 34.5 27.8926 34.5 22 34.5C16.1074 34.5 13.1612 34.5 11.3306 32.6694C9.5 30.8388 9.5 27.8926 9.5 22Z" stroke="white" stroke-width="1.8"/>
<path d="M15.75 24.5L18.6161 21.6339C19.1043 21.1457 19.8957 21.1457 20.3839 21.6339L22.3661 23.6161C22.8543 24.1043 23.6457 24.1043 24.1339 23.6161L28.25 19.5M28.25 19.5V22.625M28.25 19.5H25.125" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                        ...
                        <div className="item">
                            <div className="item-inner">
                                <span>
                                    <svg width="45" height="44" viewBox="0 0 45 44" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="0.666504" width="44" height="44" rx="12" fill="#5B93FF"/>
<path d="M34.8333 15.75L25.6087 24.9183C24.3616 26.1578 23.7381 26.7776 22.9646 26.7775C22.1912 26.7774 21.5678 26.1575 20.321 24.9177L20.0218 24.6202C18.7739 23.3794 18.15 22.7589 17.376 22.7592C16.6021 22.7595 15.9786 23.3804 14.7316 24.6222L9.83325 29.5M34.8333 15.75V22.6823M34.8333 15.75H27.8556" stroke="white" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
        ...
        <div className="grid grid-cols-2 gap-6 chart" >
          <div className="bg-white p-4 rounded-md shadow margin">
            <div className="flex justify-between items-center mb-2">
              <p className="text-sm font-medium">Average Order Value Over Time</p>
            ...
            <ResponsiveContainer width="100%" height={200}>
              <LineChart data={data}>
                ...
                <YAxis />
                <Tooltip />
                <Line type="monotone" dataKey="value" stroke="#00AEEF" strokeWidth={2} />
              </LineChart>
            </ResponsiveContainer>
          </div>
          <div className="bg-white p-4 rounded-md shadow">
            <div className="flex justify-between items-center mb-2">
              <p className="text-sm font-medium">Conversion Rate Over Time</p>
              <select className="text-sm border rounded p-1">
                <option>12 months</option>
              </select>
            </div>
